...
class ExtensionPolicy(BaseModel):
    ...
    max_repl_sessions: int = Field(default=8, ge=1, le=64)
    max_repl_cells: int = Field(default=1024, ge=1, le=10_000)
    max_repl_session_seconds: int = Field(default=15 * 60, ge=60, le=24 * 60 * 60)
